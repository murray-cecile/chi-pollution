...
WITH SERDEPROPERTIES ('hbase.columns.mapping' = ':key,info:node_id,info:node_vsn,db:db_sum,db:db_ct,db:db_max,complaints:air_pollution,complaints:asbestos,complaints:illegal_dumping,complaints:noise_complaint,complaints:vehicle_idling,complaints:recycling,complaints:water_pollution,complaints:storage_tanks,complaints:doe_tanks,complaints:toxic_materials,complaints:abandoned_site,complaints:construction_demolition,complaints:other')
